...
public struct FeedModel {
    ...
    public static let mockData: [FeedModel] = [
        FeedModel(itemImg: .image10, name: "아이폰17PRO MAX", price: "1,990,000원", isScrap: false),
        FeedModel(itemImg: .image11, name: "airPod PRO 3", price: "330,000원", isScrap: false),
        FeedModel(itemImg: .image30, name: "커피머신", price: "100,000원", isScrap: false),
        FeedModel(itemImg: .image27, name: "샌드위치", price: "8,000원", isScrap: false),
