...
final class WelcomeViewController_Closure: UIViewController, UITextViewDelegate {
    ...
    private func bindID() {
        guard var name = self.name else { return }
        if name.isEmpty {
            name = "회원"
        }
    ...
    private func backToLoginButtonDidTap() {
        ...
        completionHandler?("\(nickname)님이 다시 로그인하기 버튼을 눌렀어요")
